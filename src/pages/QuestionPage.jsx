...
import Question from './contents/Question'; // 새로운 데이터 가져오기
...
function QuestionPage() {
  ...
  const currentQuestionData = Question[currentQuestion]; // 현재 질문의 데이터 가져오기

  return (
    <>
      <div>QuestionPage</div>
      <span>{currentQuestionData.question}</span> {/* 현재 질문 표시 */}
      <QuestionContainer>
